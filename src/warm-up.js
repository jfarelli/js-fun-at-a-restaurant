...
function favoriteFood(isFavorite){
  if (isFavorite === true) {
...
var vegetables = ['Spinach', 'Kale', 'Broccoli', 'Sweet Potatoes', 'Carrots'];
...
// different fruits.
var fruits = ['Watermellon', 'Oranges', 'Mangos', 'Apples', 'Papaya'];
...
var groceryStore = {
 ...
 /* daysOpen: ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'], location: 'Montrose, CO' */
